...
class H1UnitreeDoF(DoFConfig):
    ...
    default_pos: list[float] | None = [0, 0.0, -0.1, 0.3, -0.2, 0, 0.0, -0.1, 0.3, -0.2]

    stiffness: list[float] | None = [150, 150, 150, 200, 40, 150, 150, 150, 200, 40]

    damping: list[float] | None = [2, 2, 2, 4, 2, 2, 2, 2, 4, 2]
